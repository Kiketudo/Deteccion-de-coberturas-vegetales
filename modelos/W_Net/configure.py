...
class Config:
    ...
    def __init__(self):
        ...
        #data configure
        self.pascal = r'E:\Vuelo_23032023\piribiri\imagenes'
        #r'E:\Vuelo_23032023\dataset_image\imgs\train'
        self.bsds = r'E:\Vuelo_23032023\104color'
        ...
        self.sigmaX = 4
        #testing configure
        self.model_tested = "./checkpoints/checkpoint_11_7_21_58_epoch_1000"
        #color library
        self.color_lib = []
